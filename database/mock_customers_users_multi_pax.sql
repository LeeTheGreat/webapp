...
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'galderman1@yahoo.com', 'Gabriela', 'Alderman', 'F', '2012/07/28');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'gfrancino2@joomla.org', 'Gan', 'Francino', 'M', '2013/04/10');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 77, null, null, null, null, null);
...
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'jbakesef3@berkeley.edu', 'Joycelin', 'Bakesef', 'F', '2013/05/09');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'lpeal4@hc360.com', 'Langsdon', 'Peal', 'M', '2012/10/02');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'itomsu5@posterous.com', 'Ikey', 'Tomsu', 'M', '2013/02/01');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'rsearl6@businessweek.com', 'Ricki', 'Searl', 'F', '2011/07/29');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'skulis7@bloglovin.com', 'Sybil', 'Kulis', 'F', '2011/07/01');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 72, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'dlintheadd@a8.net', 'Dionysus', 'Linthead', 'M', '2000/03/16');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'gosherin8@ucoz.com', 'Gannon', 'O''Sherin', 'M', '2018/10/31');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'dcristofor9@unicef.org', 'Darleen', 'Cristofor', 'F', '2015/10/16');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 65, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'mkalinskye@fastcompany.com', 'Marie', 'Kalinsky', 'F', '1983/11/12');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'dandraga@naver.com', 'Daffi', 'Andrag', 'F', '2017/09/01');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'rdeblaseb@alibaba.com', 'Robinet', 'De Blase', 'F', '2012/08/04');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'ibrewinc@technorati.com', 'Ingemar', 'Brewin', 'M', '2015/10/31');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 56, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'sramirez3@pcworld.com', 'Sergio', 'Ramirez', 'M', '1977/12/25');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'cpretseld@springer.com', 'Casey', 'Pretsel', 'M', '2016/04/23');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 78, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'bdelacourt6@engadget.com', 'Bo', 'Delacourt', 'M', '1994/02/22');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'rcollyere@house.gov', 'Renaldo', 'Collyer', 'M', '2014/06/07');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'gglydef@yolasite.com', 'Gabriel', 'Glyde', 'M', '2016/02/18');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 49, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'pwhitsey7@cbsnews.com', 'Priscilla', 'Whitsey', 'F', '1981/07/02');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'agrisewoodg@constantcontact.com', 'Abby', 'Grisewood', 'M', '2013/05/04');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'gthornewellh@prlog.org', 'Gavra', 'Thornewell', 'F', '2016/07/19');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 50, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'nconville8@posterous.com', 'Nixie', 'Conville', 'F', '1972/10/17');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'aheinreichf@linkedin.com', 'Alejoa', 'Heinreich', 'M', '2000/10/08');
...
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'wweatherupi@privacy.gov.au', 'Weidar', 'Weatherup', 'M', '2013/11/02');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'jsmallsmanj@cisco.com', 'Jeniffer', 'Smallsman', 'F', '2018/08/16');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'bosmintk@yellowpages.com', 'Blanch', 'Osmint', 'F', '2014/09/25');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'ezecchinil@blog.com', 'Elvyn', 'Zecchini', 'M', '2013/10/02');
...
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'lfoundsc@hc360.com', 'Lona', 'Founds', 'F', '1979/08/26');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 70, null, null, null, null, null);
...
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 72, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'omccarlet@free.fr', 'Ozzie', 'McCarle', 'M', '1958/03/19');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'ctremmelb@engadget.com', 'Cody', 'Tremmel', 'M', '2000/02/14');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 61, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'dmcgookin9@phoca.cz', 'Dede', 'McGookin', 'F', '1979/08/21');
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'fwasielewicza@posterous.com', 'Flynn', 'Wasielewicz', 'M', '1958/09/14');

insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, 49, null, null, null, null, null);
insert into customers (id, user_id, cust_email, fname, lname, gender, dob) values (null, null, 'nselewayr@unc.edu', 'Nappy', 'Seleway', 'M', '1978/12/29');
